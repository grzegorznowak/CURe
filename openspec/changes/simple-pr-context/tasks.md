...
- [x] Collapse a completed local review and its identical posted remote-footer representation to one retained `past_reviews` entry while pruning the posted discussion event once (S3/A4)
- [x] Use normative character 3-grams for Jaccard deduplication and prove the inclusive 0.85 threshold boundary (A4/TAP-02)
