...
- CURRENT CLOSURE EVIDENCE (post-incident, at `dfdff39`) — accepted five-node TAP-05 live bundle `/home/vscode/cure-tap05-proofs/tap05-ACCEPTED-20260806` (private JUnit and exact `-vv` agree on the five explicit leaf nodes, zero skips/failures/unexpected; before/after worktree manifests, installed ChunkHound/Watchman identity, invocation, and all five preserved case roots audited); CI-exact installed-wheel smoke `/home/vscode/cure-tap05-proofs/tap07-smoke-20260806.log` (fresh-resync degraded→ready and true-degraded terminal cases, keeper/DB-lock residue checks); full pytest `1001 passed, 5 skipped, 202 subtests`; Ruff; configured and scoped mypy; isolated build/Twine; focused TAP-02/TAP-03/TAP-07 rerun `171 passed, 157 subtests` including recursive-root matcher and privacy-safe diagnostics nodes; CI gate green at 390f614; fresh installed-wheel public `cure pr` route on grzegorznowak/CURe#34 (session `grzegorznowak-cure-pr34-20260806-120029-ea28`, `status: done`, tool-proof valid for all 8 runs) with an eligible witness; independent review of 390f614 (2026-08-06) with its A12/A18 keeper-loss finding closed at `dfdff39`.
...
|---|---|---|---|---|---|---|
| A1 | final | TAP-02, TAP-03 | Run keeper/flow ordering nodes including fresh-resync degraded orientation-enabled route | Focused full pytest `1001 passed, 5 skipped, 202 subtests` at `dfdff39` proves `final-index/receipt-ready → retained keeper native-health/expected-session-ready → helper-preflight → orientation-or-first-review-model` with zero pre-ready search/helper/model events | `cure.py`, lifecycle module | Closed by current focused proof and independent review of 390f614 (2026-08-06) with findings closed at `dfdff39` |
| A2 | final | TAP-02, TAP-05 | Run fake retained fresh-resync proof and enabled dedicated Watchman canary | Focused proof plus `/home/vscode/cure-tap05-proofs/tap05-ACCEPTED-20260806` proves one sanitized owned generation across reconciliation, readiness, and sequential/eight-client concurrency with no close/reopen and private fsynced ledger persistence | Lease, helper, daemon observation | Closed by exact five-node TAP-05 audit and independent review of 390f614 (2026-08-06) with findings closed at `dfdff39` |
| A3 | final | TAP-02, TAP-03 | Run retained fresh-resync and phase-gap cases | Focused full pytest `1001 passed, 5 skipped, 202 subtests` at `dfdff39` proves one lease ID spans reconciliation, readiness, and applicable phases; only typed pre-native-spawn failure may retry before dispatch | `_pr_flow_impl` | Closed by current focused proof and independent review of 390f614 (2026-08-06) with findings closed at `dfdff39` |
...
| A10 | final | TAP-02, TAP-03 | Run missing-tool, exhaustive degraded near-miss, open-vocabulary state, timeout/malformed/transport/liveness/generation, receipt/witness, and identity fault nodes | Focused proof verifies only exact fresh-instance reconciliation waits, open-vocabulary state handling, strict discriminator/fault fields, and zero dispatch plus one cleanup for every near miss | Bootstrap/native-status/expected-session/identity/filter-generation gates | Closed by full pytest `1001 passed, 5 skipped, 202 subtests` at `dfdff39` and independent review of 390f614 (2026-08-06) with findings closed at `dfdff39` |
| A11 — normal-stream receipt construction and native health | final | TAP-01, TAP-02, TAP-05 | Preserve receipt-capture proof and typed fresh-resync/near-miss `daemon_status` cases plus the dedicated Watchman canary | Focused proof and `/home/vscode/cure-tap05-proofs/tap05-ACCEPTED-20260806` verify authoritative pump capture, exact fresh reconciliation, near-miss rejection, and identity projection before witness/model work | Final-index visible pump/capture/seal/projector, exit code, canonical bootstrap, lease | Closed by current focused/live proof and independent review of 390f614 (2026-08-06) with findings closed at `dfdff39` |
| A11 — quiet and explicit-no-stream receipt construction | final | TAP-01, TAP-02, TAP-03 | Run separate public `--quiet` and explicit `--no-stream` final top-ups with the complete adversarial capture corpus | Focused full pytest `1001 passed, 5 skipped, 202 subtests` at `dfdff39` verifies zero live lines, capture-forced authority parity, bounded replay/memory, and spool disposal for both routes | `_pr_flow_impl`, final-index owner, `ReviewflowOutput.run_logged_cmd`, `run_cmd` silent pump transport, private spools | Closed by current focused proof and independent review of 390f614 (2026-08-06) with findings closed at `dfdff39` |
| A11 — non-empty witness | final | TAP-02, TAP-05 | Run deterministic fresh-resync fake and dedicated Watchman live witness nodes | `/home/vscode/cure-tap05-proofs/tap05-ACCEPTED-20260806` plus focused proof verifies no pre-ready search and then a path-constrained native witness with the separate 60-second timeout | Witness selector, keeper session, session DB | Closed by exact live witness proof and independent review of 390f614 (2026-08-06) with findings closed at `dfdff39` |
| A11 — zero-chunk, malformed search, and no-witness failures | final | TAP-02, TAP-05 | Preserve zero/no-witness proof and run typed fresh-resync plus exhaustive malformed/degraded status branches | Focused proof and both zero-chunk leaves in `/home/vscode/cure-tap05-proofs/tap05-ACCEPTED-20260806` verify exact projection/new generation/healthy status, no invented search, and fail-closed malformed/no-witness handling | Raw summary, receipt, generation adjudicator, keeper session, filter probe identity | Closed by current deterministic/live proof and independent review of 390f614 (2026-08-06) with findings closed at `dfdff39` |
...
| A22 | final | TAP-02, TAP-03, TAP-05, TAP-06 | Use deterministic rejection/static proof and the four ordinary plus dedicated Watchman live cases | Focused/static proof rejects stale generations and boundary escapes; `/home/vscode/cure-tap05-proofs/tap05-ACCEPTED-20260806` proves four strict ordinary deltas plus actual regular Watchman files, direct installed `RealtimePathFilter` exclusion for every added path, corpus exclusion, continuity, and release | Config materializer/effective-filter generation gate, manifests, keeper/index/cleanup, live native tools and DB/corpus evidence | Closed by manifest-bound exact five-node audit and independent review of 390f614 (2026-08-06) with findings closed at `dfdff39` |
| A23 | final | TAP-07 | Run isolated build/Twine/wheel smoke and release owner | `/home/vscode/cure-tap05-proofs/tap07-smoke-20260806.log` proves the installed production lifecycle API outside checkout completes fresh-resync and true-degraded terminal cleanup; installed `cure --help` verifies the entrypoint separately | Wheel and smoke harness | Closed by all eight zero-exit TAP-07 steps, `13 passed`, and independent review of 390f614 (2026-08-06) with findings closed at `dfdff39`; no installed CLI `_pr_flow_impl` claim |
