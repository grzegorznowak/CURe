...
| 04 | 🟢 PLAN APPROVED | 🔄 IN PROGRESS | Review Runtime Integration, Guardrails, Memory, and Landmark Trace | 01, 02, 03 | `openspec/changes/story-04-review-runtime-integration-guardrails-memory-trace/` |
...
- No Story 05 workspace remains after remap. FB-030/031/034/runtime-FB-035/036/038 amend Story 04; FB-033/037 amend Story 01; FB-032 and the source-truth side of FB-035 amend Story 03.

Legacy feedback-derived story candidates and absorption history are preserved in `feedback-log.md`. Previously open candidates FB-007 (final-report provenance surfacing) and FB-010 (decision/intake discussion evidence reuse) are represented in Story 04 scope. FB-030 through FB-038 are a remap exception: they amend the pre-existing stories that PR #22 actually covered, while the synthetic Story 05 workspace has been removed after preserving the audit trail in this initiative's feedback log and story addenda. FB-039 through FB-042 reopen Story 04 planning for source-verification cache persistence, stable replay identity, safe terminal non-reportable replay, and verifier fan-out telemetry.
