...
class PromptTemplateTests(unittest.TestCase):
    ...
    def test_verbose_finding_mode_guidance_renders_required_fields_for_final_reviews(self) -> None:
        ...
        for path in prompt_paths:
            ...
            self.assertIn("- <finding summary> Sources: `file:line`", rendered)
            ...
            self.assertIn("strict synth grounding validates the top-level bullet line", rendered)
            self.assertNotIn("Sources: `file:line`, `file:line`", rendered)
...
class WorkflowContractTests(unittest.TestCase):
    ...
    def test_commands_flow_json_returns_curated_agent_catalog(self) -> None:
        ...
        self.assertEqual(names, ["pr", "resume", "clean", "status", "watch", "explain"])
