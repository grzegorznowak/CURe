...
class InstallAndDoctorTests(unittest.TestCase):
    ...
    def test_readme_documents_uv_tool_install_flow(self) -> None:
        ...
        self.assertIn("Human Operator Setup", readme)
        self.assertIn("Fast Reference", readme)
        ...
        self.assertIn("Sync CURe with your agents", readme)
        self.assertIn("project.reviewflow.toml", readme)
        self.assertIn("The project itself does not need to import CURe.", readme)
