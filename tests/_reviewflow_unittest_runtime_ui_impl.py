...
class InstallAndDoctorTests(unittest.TestCase):
    ...
    def test_readme_documents_uv_tool_install_flow(self) -> None:
        ...
        self.assertIn("curl -fsSL https://raw.githubusercontent.com/grzegorznowak/CURe/main/install-cure.sh | sh -s -- --version v0.1.5", readme)
        ...
        self.assertIn("curl -fsSL https://raw.githubusercontent.com/grzegorznowak/CURe/main/install-cure.sh | sh -s -- --version v0.1.5", skill)
